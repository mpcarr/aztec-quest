...
Dim counter_beasts : Set counter_beasts = (new Counter)("beasts", mode_beasts, Array("mode_beasts_started", "diverter_panther_deactivating"), Array("s_left_ramp_opto_active"), 2, True, True, Array("activate_panther"), True)
